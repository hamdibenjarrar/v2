            ...
            <Card className="bg-white shadow-lg rounded-2xl border border-gray-200/50 overflow-hidden">
              <CardContent className="p-4">
                <div className="w-full h-[500px]">
                  <iframe 
                    src="https://www.facebook.com/plugins/video.php?height=476&href=https%3A%2F%2Fwww.facebook.com%2Ffaza.tn%2Fvideos%2F1622593341437331%2F&show_text=false&width=560&t=0" 
