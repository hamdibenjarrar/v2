...
import { Music, Handshake, Film } from 'lucide-react';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import Image from 'next/image';

export default function CrescendoProjectPage() {
  const t = useTranslations('CrescendoProject');
  ...
  return (
    <div className="bg-background">
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative h-96 w-full rounded-2xl overflow-hidden shadow-2xl">
              <Image src="/cresc.jpg" alt={t('title')} fill className="object-cover" />
            </div>
            <div>
              <h2 className="text-3xl font-bold text-primary font-headline mb-4">{t('about.title')}</h2>
      ...
      <AnimatedSection className="py-24 md:py-32 bg-secondary">
          <div className="container">
              <h2 className="text-3xl text-center font-bold text-primary font-headline mb-12">{t('features.title')}</h2>
